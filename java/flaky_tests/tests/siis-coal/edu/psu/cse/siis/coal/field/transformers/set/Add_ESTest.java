...
public class Add_ESTest extends Add_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      add0.add = (Set<Object>) linkedHashSet0;
      Add add1 = new Add(add0);
      FieldTransformer fieldTransformer0 = add0.compose(add1);
      assertFalse(fieldTransformer0.equals((Object)add0));
  }
  ...
  public void test2()  throws Throwable  {
      ...
      Add add1 = new Add(add0);
      LinkedHashSet<Object> linkedHashSet0 = new LinkedHashSet<Object>();
      add1.add = (Set<Object>) linkedHashSet0;
      linkedHashSet0.add(add1);
      Add add2 = null;
      try {
        add2 = new Add(add1);
  ...
  public void test4()  throws Throwable  {
      Object object0 = new Object();
      Add add0 = new Add(object0);
      FieldTransformer fieldTransformer0 = add0.compose(add0);
      assertNotSame(fieldTransformer0, add0);
  }
  ...
  public void test6()  throws Throwable  {
      Object object0 = new Object();
      Add add0 = new Add(object0);
      Set<Object> set0 = add0.add;
      Add add1 = new Add(set0);
      assertTrue(add1.equals((Object)add0));
  }
}
