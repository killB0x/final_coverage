...
public class MultimediaParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.MultimediaParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MultimediaParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.MultimediaParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MultimediaParser_ESTest_scaffolding.class.getClassLoader()); 
