...
public class AssociationParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.AssociationParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AssociationParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.AssociationParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AssociationParser_ESTest_scaffolding.class.getClassLoader()); 
