...
public class UserReferenceParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.UserReferenceParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(UserReferenceParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.UserReferenceParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(UserReferenceParser_ESTest_scaffolding.class.getClassLoader()); 
