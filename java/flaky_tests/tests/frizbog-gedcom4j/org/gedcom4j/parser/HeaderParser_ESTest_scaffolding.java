...
public class HeaderParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.HeaderParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HeaderParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.HeaderParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HeaderParser_ESTest_scaffolding.class.getClassLoader()); 
