...
public class SourceParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.SourceParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SourceParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.SourceParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SourceParser_ESTest_scaffolding.class.getClassLoader()); 
