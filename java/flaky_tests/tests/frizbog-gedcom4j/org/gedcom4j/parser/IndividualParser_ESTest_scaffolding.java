...
public class IndividualParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.IndividualParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(IndividualParser_ESTest_scaffolding.class.getClassLoader() ,
      "org.gedcom4j.parser.IndividualParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(IndividualParser_ESTest_scaffolding.class.getClassLoader()); 
