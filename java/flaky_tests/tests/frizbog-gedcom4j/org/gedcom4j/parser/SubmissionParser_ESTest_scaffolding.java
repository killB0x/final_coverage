...
public class SubmissionParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.SubmissionParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SubmissionParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.SubmissionParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SubmissionParser_ESTest_scaffolding.class.getClassLoader()); 
