...
public class SubmitterParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.SubmitterParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SubmitterParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.SubmitterParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SubmitterParser_ESTest_scaffolding.class.getClassLoader()); 
