...
public class ChangeDateParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.ChangeDateParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ChangeDateParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.ChangeDateParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ChangeDateParser_ESTest_scaffolding.class.getClassLoader()); 
