...
public class LdsSpouseSealingParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.LdsSpouseSealingParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LdsSpouseSealingParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.LdsSpouseSealingParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LdsSpouseSealingParser_ESTest_scaffolding.class.getClassLoader()); 
