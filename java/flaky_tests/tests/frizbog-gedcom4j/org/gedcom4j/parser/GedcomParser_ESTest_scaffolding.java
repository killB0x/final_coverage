...
public class GedcomParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.GedcomParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GedcomParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.event.ParseProgressEvent",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.gedcom4j.io.event.FileProgressListener", false, GedcomParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.gedcom4j.parser.event.ParseProgressListener", false, GedcomParser_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GedcomParser_ESTest_scaffolding.class.getClassLoader()); 
