...
public class HeaderSourceDataParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.HeaderSourceDataParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HeaderSourceDataParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.HeaderSourceDataParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HeaderSourceDataParser_ESTest_scaffolding.class.getClassLoader()); 
