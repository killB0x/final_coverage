...
public class NoteRecordParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.NoteRecordParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NoteRecordParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.NoteRecordParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NoteRecordParser_ESTest_scaffolding.class.getClassLoader()); 
