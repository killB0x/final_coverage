...
public class CorporationParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.CorporationParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CorporationParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.CorporationParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CorporationParser_ESTest_scaffolding.class.getClassLoader()); 
