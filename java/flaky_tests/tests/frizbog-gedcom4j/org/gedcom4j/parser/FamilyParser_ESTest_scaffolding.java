...
public class FamilyParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.FamilyParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FamilyParser_ESTest_scaffolding.class.getClassLoader() ,
      "org.gedcom4j.parser.FamilyParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FamilyParser_ESTest_scaffolding.class.getClassLoader()); 
