...
public class GedcomVersionParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.parser.GedcomVersionParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GedcomVersionParser_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.gedcom4j.parser.GedcomVersionParser",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GedcomVersionParser_ESTest_scaffolding.class.getClassLoader()); 
