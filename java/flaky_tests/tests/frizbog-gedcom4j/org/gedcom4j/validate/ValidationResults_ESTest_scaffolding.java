...
public class ValidationResults_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.gedcom4j.validate.ValidationResults"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ValidationResults_ESTest_scaffolding.class.getClassLoader() ,
      "org.gedcom4j.model.HasCustomFacts",
      "org.gedcom4j.validate.AutoRepair",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ValidationResults_ESTest_scaffolding.class.getClassLoader()); 
