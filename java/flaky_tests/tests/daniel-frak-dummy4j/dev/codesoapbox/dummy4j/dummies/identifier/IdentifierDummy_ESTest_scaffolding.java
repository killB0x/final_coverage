...
public class IdentifierDummy_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "dev.codesoapbox.dummy4j.dummies.identifier.IdentifierDummy"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(IdentifierDummy_ESTest_scaffolding.class.getClassLoader() ,
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.InternationalStandardNumberFactory",
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.namenumber.OrcidBuilder",
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.serialnumber.IssnFactory",
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.booknumber.IsbnBuilder",
      "dev.codesoapbox.dummy4j.definitions.DefaultUniqueValues",
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.booknumber.IsbnRegistrationGroupRange",
      ...
      "dev.codesoapbox.dummy4j.dummies.shared.string.StringFormatter",
      ...
      "dev.codesoapbox.dummy4j.dummies.shared.checkdigitformulas.CheckDigit10AsXFormatter",
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.articlenumber.Gtin14Builder",
      "dev.codesoapbox.dummy4j.exceptions.InvalidRangeException",
      ...
      "dev.codesoapbox.dummy4j.exceptions.InvalidDefinitionException",
      "dev.codesoapbox.dummy4j.dummies.address.AddressDummy",
      "dev.codesoapbox.dummy4j.exceptions.IvalidIsniParameterException",
      ...
      "dev.codesoapbox.dummy4j.dummies.shared.string.Padding",
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.articlenumber.Gtin8Builder",
      "dev.codesoapbox.dummy4j.exceptions.ValueOutOfRangeException",
      ...
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.articlenumber.Gtin13Builder",
      ...
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.musicnumber.Ismn",
      ...
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.booknumber.Isbn",
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.articlenumber.UpcFactory",
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.musicnumber.IsmnBuilder",
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.booknumber.IsbnType",
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.musicnumber.IsmnRegistrantRange",
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.namenumber.IsniBuilder",
      ...
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.articlenumber.Gs1PrefixRange",
      ...
      "dev.codesoapbox.dummy4j.dummies.shared.math.NumberValidator"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(IdentifierDummy_ESTest_scaffolding.class.getClassLoader()); 
