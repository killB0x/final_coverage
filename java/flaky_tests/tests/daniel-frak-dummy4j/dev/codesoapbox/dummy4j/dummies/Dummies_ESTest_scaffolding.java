...
public class Dummies_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "dev.codesoapbox.dummy4j.dummies.Dummies"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Dummies_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "dev.codesoapbox.dummy4j.dummies.color.CMYK",
      "dev.codesoapbox.dummy4j.dummies.DateAndTimeDummy",
      "dev.codesoapbox.dummy4j.dummies.finance.CreditCardBuilder",
      ...
      "dev.codesoapbox.dummy4j.dummies.color.HSBA",
      ...
      "dev.codesoapbox.dummy4j.dummies.finance.IbanBuilder",
      "dev.codesoapbox.dummy4j.dummies.shared.checkdigitformulas.ModElevenFormula",
      "dev.codesoapbox.dummy4j.dummies.Dummies",
      "dev.codesoapbox.dummy4j.dummies.color.HSL",
      "dev.codesoapbox.dummy4j.dummies.color.HSLA",
      ...
      "dev.codesoapbox.dummy4j.dummies.address.Address",
      "dev.codesoapbox.dummy4j.dummies.color.HSB",
      "dev.codesoapbox.dummy4j.dummies.internet.UrlBuilder",
      "dev.codesoapbox.dummy4j.dummies.finance.BankAccountCountry",
      "dev.codesoapbox.dummy4j.dummies.identifier.internationalnumber.articlenumber.Gtin13Builder",
      "dev.codesoapbox.dummy4j.dummies.finance.CreditCardProvider",
      ...
      "dev.codesoapbox.dummy4j.dummies.finance.PriceBuilder",
      "dev.codesoapbox.dummy4j.dummies.finance.CreditCardNumberBuilder",
      ...
      "dev.codesoapbox.dummy4j.dummies.finance.CreditCard"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Dummies_ESTest_scaffolding.class.getClassLoader()); 
