...
public class ReCheckCookieInterceptor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.github.echisan.wbp4j.interceptor.ReCheckCookieInterceptor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ReCheckCookieInterceptor_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ReCheckCookieInterceptor_ESTest_scaffolding.class.getClassLoader()); 
