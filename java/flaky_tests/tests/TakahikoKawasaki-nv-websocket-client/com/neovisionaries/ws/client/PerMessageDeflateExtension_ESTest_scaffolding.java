...
public class PerMessageDeflateExtension_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.neovisionaries.ws.client.PerMessageDeflateExtension"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PerMessageDeflateExtension_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PerMessageDeflateExtension_ESTest_scaffolding.class.getClassLoader()); 
