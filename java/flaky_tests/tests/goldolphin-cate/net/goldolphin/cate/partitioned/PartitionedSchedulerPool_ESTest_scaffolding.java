...
public class PartitionedSchedulerPool_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.goldolphin.cate.partitioned.PartitionedSchedulerPool"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PartitionedSchedulerPool_ESTest_scaffolding.class.getClassLoader() ,
      "net.goldolphin.cate.Task",
      "net.goldolphin.cate.ExecutorScheduler",
      "net.goldolphin.cate.partitioned.IPartitioner",
      "net.goldolphin.cate.SynchronizedScheduler",
      "net.goldolphin.cate.IScheduler",
      "net.goldolphin.cate.partitioned.HashedPartitioner",
      "net.goldolphin.cate.ITask",
      "net.goldolphin.cate.Environment",
      "net.goldolphin.cate.partitioned.PartitionedSchedulerPool",
      "net.goldolphin.cate.TaskWithInitState",
      "net.goldolphin.cate.IContinuation"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.lang.ThreadGroup", false, PartitionedSchedulerPool_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.concurrent.ThreadFactory", false, PartitionedSchedulerPool_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PartitionedSchedulerPool_ESTest_scaffolding.class.getClassLoader()); 
