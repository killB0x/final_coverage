...
public class TaskWithScheduler_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.goldolphin.cate.TaskWithScheduler"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TaskWithScheduler_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.goldolphin.cate.ContextAction", false, TaskWithScheduler_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.goldolphin.cate.Func1", false, TaskWithScheduler_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TaskWithScheduler_ESTest_scaffolding.class.getClassLoader()); 
