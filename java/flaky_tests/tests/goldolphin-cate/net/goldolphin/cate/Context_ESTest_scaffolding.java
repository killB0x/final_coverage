...
public class Context_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.goldolphin.cate.Context"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.goldolphin.cate.ContextAction", false, Context_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.goldolphin.cate.Func0", false, Context_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.goldolphin.cate.Func1", false, Context_ESTest_scaffolding.class.getClassLoader()));
  }
