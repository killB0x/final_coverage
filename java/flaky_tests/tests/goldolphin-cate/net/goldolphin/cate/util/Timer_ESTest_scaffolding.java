...
public class Timer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.goldolphin.cate.util.Timer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Timer_ESTest_scaffolding.class.getClassLoader() ,
      "net.goldolphin.cate.util.ExecutorTimer",
      "net.goldolphin.cate.Task",
      "net.goldolphin.cate.util.Timer$1",
      "net.goldolphin.cate.util.Timer$2",
      ...
      "net.goldolphin.cate.util.Timer",
      "net.goldolphin.cate.util.ExecutorTimer$1",
      "net.goldolphin.cate.Func1Task",
      "net.goldolphin.cate.WhenAnyTask",
      "net.goldolphin.cate.CollectTask",
      "net.goldolphin.cate.Maybe",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.goldolphin.cate.Action1", false, Timer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.goldolphin.cate.Context", false, Timer_ESTest_scaffolding.class.getClassLoader()));
  }
