...
public class CollectTask_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.goldolphin.cate.CollectTask"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CollectTask_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.concurrent.ThreadFactory", false, CollectTask_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.goldolphin.cate.ContextAction", false, CollectTask_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.goldolphin.cate.Func1", false, CollectTask_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CollectTask_ESTest_scaffolding.class.getClassLoader()); 
