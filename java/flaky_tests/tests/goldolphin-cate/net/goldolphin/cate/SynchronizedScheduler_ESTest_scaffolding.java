...
public class SynchronizedScheduler_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.goldolphin.cate.SynchronizedScheduler"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SynchronizedScheduler_ESTest_scaffolding.class.getClassLoader() ,
      "net.goldolphin.cate.Task",
      "net.goldolphin.cate.Unit",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.goldolphin.cate.Action0", false, SynchronizedScheduler_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.goldolphin.cate.ContextAction", false, SynchronizedScheduler_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.goldolphin.cate.Func1", false, SynchronizedScheduler_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SynchronizedScheduler_ESTest_scaffolding.class.getClassLoader()); 
