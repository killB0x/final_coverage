...
public class IntegerTypeHandler_ESTest extends IntegerTypeHandler_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      integerTypeHandler0.setNonNullParameter(preparedStatement0, 207, integer0, jdbcType0);
  ...
  public void test1()  throws Throwable  {
      ...
      Integer integer0 = integerTypeHandler0.getNullableResult(resultSet0, 0);
  ...
  public void test2()  throws Throwable  {
      IntegerTypeHandler integerTypeHandler0 = new IntegerTypeHandler();
      ResultSet resultSet0 = mock(ResultSet.class, new ViolatedAssumptionAnswer());
      doReturn(878).when(resultSet0).getInt(anyInt());
      Integer integer0 = integerTypeHandler0.getNullableResult(resultSet0, (-1481));
  ...
  public void test3()  throws Throwable  {
      IntegerTypeHandler integerTypeHandler0 = new IntegerTypeHandler();
      ResultSet resultSet0 = mock(ResultSet.class, new ViolatedAssumptionAnswer());
      doReturn((-715)).when(resultSet0).getInt(anyInt());
      Integer integer0 = integerTypeHandler0.getNullableResult(resultSet0, 0);
  ...
  public void test5()  throws Throwable  {
      ...
      try { 
        integerTypeHandler0.setNonNullParameter((PreparedStatement) null, (-1200), integer0, jdbcType0);
  ...
  public void test6()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        integerTypeHandler0.getNullableResult((ResultSet) null, 0);
        fail("Expecting exception: NullPointerException");
