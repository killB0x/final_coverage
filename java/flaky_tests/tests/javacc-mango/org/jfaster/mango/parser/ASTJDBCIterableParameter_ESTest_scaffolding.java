...
public class ASTJDBCIterableParameter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.jfaster.mango.parser.ASTJDBCIterableParameter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ASTJDBCIterableParameter_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.jfaster.mango.parser.EmptyArrayException",
      ...
      "org.jfaster.mango.parser.EmptyCollectionException",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.Enumeration", false, ASTJDBCIterableParameter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("org.jfaster.mango.type.TypeHandler", false, ASTJDBCIterableParameter_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ASTJDBCIterableParameter_ESTest_scaffolding.class.getClassLoader()); 
