...
public class ArrayResultSetExtractor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.jfaster.mango.jdbc.ArrayResultSetExtractor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ArrayResultSetExtractor_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "org.jfaster.mango.jdbc.ArrayResultSetExtractor",
      "org.jfaster.mango.exception.UncheckedException"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.sql.ResultSet", false, ArrayResultSetExtractor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.ResultSetMetaData", false, ArrayResultSetExtractor_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ArrayResultSetExtractor_ESTest_scaffolding.class.getClassLoader()); 
