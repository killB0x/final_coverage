...
public class BuildinAddAndReturnGeneratedIdBuilderFactory_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.jfaster.mango.crud.buildin.factory.BuildinAddAndReturnGeneratedIdBuilderFactory"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BuildinAddAndReturnGeneratedIdBuilderFactory_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.jfaster.mango.crud.CrudMeta", false, BuildinAddAndReturnGeneratedIdBuilderFactory_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BuildinAddAndReturnGeneratedIdBuilderFactory_ESTest_scaffolding.class.getClassLoader()); 
