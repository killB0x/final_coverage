...
public class ConditionalExecutor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "executionChains.chainExecutors.ConditionalExecutor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ConditionalExecutor_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("executionChains.Chain", false, ConditionalExecutor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("executionChains.ChainFunction", false, ConditionalExecutor_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ConditionalExecutor_ESTest_scaffolding.class.getClassLoader()); 
