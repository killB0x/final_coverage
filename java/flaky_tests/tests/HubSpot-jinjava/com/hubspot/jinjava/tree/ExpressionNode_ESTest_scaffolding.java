...
public class ExpressionNode_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.hubspot.jinjava.tree.ExpressionNode"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ExpressionNode_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.hubspot.jinjava.lib.expression.ExpressionStrategy",
      "com.hubspot.jinjava.interpret.UnexpectedTokenException",
      "com.hubspot.jinjava.interpret.JinjavaInterpreter",
      "com.hubspot.jinjava.tree.output.RenderedOutputNode"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.hubspot.jinjava.tree.parse.ExpressionToken", false, ExpressionNode_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ExpressionNode_ESTest_scaffolding.class.getClassLoader()); 
