...
public class TemplateError_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.hubspot.jinjava.interpret.TemplateError"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TemplateError_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.hubspot.jinjava.interpret.UnknownTagException",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TemplateError_ESTest_scaffolding.class.getClassLoader()); 
