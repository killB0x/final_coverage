...
public class IsTruthyExpTest_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.hubspot.jinjava.lib.exptest.IsTruthyExpTest"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(IsTruthyExpTest_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.hubspot.jinjava.util.HasObjectTruthValue",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(IsTruthyExpTest_ESTest_scaffolding.class.getClassLoader()); 
