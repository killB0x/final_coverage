...
public class BitCondition_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.iciql.BitCondition"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BitCondition_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.iciql.BitCondition$Bitwise",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.iciql.Iciql$DataTypeAdapter", false, BitCondition_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BitCondition_ESTest_scaffolding.class.getClassLoader()); 
