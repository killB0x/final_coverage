...
public class RuntimeParameter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.iciql.RuntimeParameter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RuntimeParameter_ESTest_scaffolding.class.getClassLoader() ,
      "com.iciql.Token",
      "com.iciql.Db",
      "com.iciql.Query",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RuntimeParameter_ESTest_scaffolding.class.getClassLoader()); 
