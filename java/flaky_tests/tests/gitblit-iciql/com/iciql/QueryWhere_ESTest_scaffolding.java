...
public class QueryWhere_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.iciql.QueryWhere"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(QueryWhere_ESTest_scaffolding.class.getClassLoader() ,
      "com.iciql.ValueCount",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(QueryWhere_ESTest_scaffolding.class.getClassLoader()); 
