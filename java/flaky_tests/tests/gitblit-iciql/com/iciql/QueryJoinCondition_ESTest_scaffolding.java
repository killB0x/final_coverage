...
public class QueryJoinCondition_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.iciql.QueryJoinCondition"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(QueryJoinCondition_ESTest_scaffolding.class.getClassLoader() ,
      "com.iciql.Token",
      "com.iciql.Query",
      "com.iciql.Condition",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(QueryJoinCondition_ESTest_scaffolding.class.getClassLoader()); 
