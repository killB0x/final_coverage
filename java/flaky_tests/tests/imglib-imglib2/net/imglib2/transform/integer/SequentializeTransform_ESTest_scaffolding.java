...
public class SequentializeTransform_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.transform.integer.SequentializeTransform"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SequentializeTransform_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.imglib2.transform.integer.SequentializeTransform$1",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SequentializeTransform_ESTest_scaffolding.class.getClassLoader()); 
