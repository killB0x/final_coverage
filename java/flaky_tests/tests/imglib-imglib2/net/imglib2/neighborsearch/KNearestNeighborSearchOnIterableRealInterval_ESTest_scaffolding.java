...
public class KNearestNeighborSearchOnIterableRealInterval_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.neighborsearch.KNearestNeighborSearchOnIterableRealInterval"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(KNearestNeighborSearchOnIterableRealInterval_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Supplier", false, KNearestNeighborSearchOnIterableRealInterval_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(KNearestNeighborSearchOnIterableRealInterval_ESTest_scaffolding.class.getClassLoader()); 
