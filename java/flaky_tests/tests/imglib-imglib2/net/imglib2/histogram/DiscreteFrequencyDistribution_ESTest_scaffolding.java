...
public class DiscreteFrequencyDistribution_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.histogram.DiscreteFrequencyDistribution"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DiscreteFrequencyDistribution_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Supplier", false, DiscreteFrequencyDistribution_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.histogram.BinMapper1d", false, DiscreteFrequencyDistribution_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DiscreteFrequencyDistribution_ESTest_scaffolding.class.getClassLoader()); 
