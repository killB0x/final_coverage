...
public class ArrayImgXYShortProjector_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.display.projector.specialized.ArrayImgXYShortProjector"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ArrayImgXYShortProjector_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.imglib2.display.projector.specialized.ArrayImgXYShortProjector",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.imglib2.img.array.ArrayImg", false, ArrayImgXYShortProjector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.img.basictypeaccess.array.ShortArray", false, ArrayImgXYShortProjector_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.type.numeric.integer.UnsignedShortType", false, ArrayImgXYShortProjector_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ArrayImgXYShortProjector_ESTest_scaffolding.class.getClassLoader()); 
