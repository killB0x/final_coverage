...
public class SamplingProjector2D_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.display.projector.sampler.SamplingProjector2D"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SamplingProjector2D_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.imglib2.display.projector.sampler.IntervalSampler",
      ...
      "net.imglib2.display.projector.sampler.SelectiveSampler",
      ...
      "net.imglib2.Dirty",
      "net.imglib2.display.projector.sampler.SamplingProjector2D",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiConsumer", false, SamplingProjector2D_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Supplier", false, SamplingProjector2D_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.converter.Converter", false, SamplingProjector2D_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SamplingProjector2D_ESTest_scaffolding.class.getClassLoader()); 
