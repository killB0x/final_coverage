...
public class PointSampleList_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.PointSampleList"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PointSampleList_ESTest_scaffolding.class.getClassLoader() ,
      "net.imglib2.img.list.ListImgFactory",
      "net.imglib2.transform.Transform",
      "net.imglib2.AbstractWrappedPositionableLocalizable",
      ...
      "net.imglib2.AbstractWrappedLocalizable",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PointSampleList_ESTest_scaffolding.class.getClassLoader()); 
