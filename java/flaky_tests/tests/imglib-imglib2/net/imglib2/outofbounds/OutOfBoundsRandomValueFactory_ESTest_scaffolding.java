...
public class OutOfBoundsRandomValueFactory_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.outofbounds.OutOfBoundsRandomValueFactory"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OutOfBoundsRandomValueFactory_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.imglib2.RealRandomAccessible", false, OutOfBoundsRandomValueFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.img.basictypeaccess.IntAccess", false, OutOfBoundsRandomValueFactory_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OutOfBoundsRandomValueFactory_ESTest_scaffolding.class.getClassLoader()); 
