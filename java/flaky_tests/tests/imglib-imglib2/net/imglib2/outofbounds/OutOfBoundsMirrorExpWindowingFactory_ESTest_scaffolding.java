...
public class OutOfBoundsMirrorExpWindowingFactory_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.outofbounds.OutOfBoundsMirrorExpWindowingFactory"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OutOfBoundsMirrorExpWindowingFactory_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiConsumer", false, OutOfBoundsMirrorExpWindowingFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Supplier", false, OutOfBoundsMirrorExpWindowingFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.img.cell.LazyCellImg$Get", false, OutOfBoundsMirrorExpWindowingFactory_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OutOfBoundsMirrorExpWindowingFactory_ESTest_scaffolding.class.getClassLoader()); 
