...
public class RealOutOfBoundsRealRandomAccess_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.outofbounds.RealOutOfBoundsRealRandomAccess"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RealOutOfBoundsRealRandomAccess_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Supplier", false, RealOutOfBoundsRealRandomAccess_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.outofbounds.RealOutOfBounds", false, RealOutOfBoundsRealRandomAccess_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RealOutOfBoundsRealRandomAccess_ESTest_scaffolding.class.getClassLoader()); 
