...
public class RealDoubleSamplerConverter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.converter.readwrite.RealDoubleSamplerConverter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RealDoubleSamplerConverter_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Supplier", false, RealDoubleSamplerConverter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.PointSampleList", false, RealDoubleSamplerConverter_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.img.basictypeaccess.DoubleAccess", false, RealDoubleSamplerConverter_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RealDoubleSamplerConverter_ESTest_scaffolding.class.getClassLoader()); 
