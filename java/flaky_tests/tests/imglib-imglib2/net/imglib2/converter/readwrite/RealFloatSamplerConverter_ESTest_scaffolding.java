...
public class RealFloatSamplerConverter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.converter.readwrite.RealFloatSamplerConverter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RealFloatSamplerConverter_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.imglib2.converter.readwrite.RealFloatSamplerConverter",
      ...
      "net.imglib2.converter.readwrite.RealFloatSamplerConverter$RealConvertingFloatAccess",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RealFloatSamplerConverter_ESTest_scaffolding.class.getClassLoader()); 
