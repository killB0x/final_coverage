...
public class WriteConvertedIterableInterval_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.converter.readwrite.WriteConvertedIterableInterval"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(WriteConvertedIterableInterval_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.imglib2.converter.readwrite.SamplerConverter", false, WriteConvertedIterableInterval_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(WriteConvertedIterableInterval_ESTest_scaffolding.class.getClassLoader()); 
