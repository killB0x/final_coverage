...
public class CompositeARGBSamplerConverter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.converter.readwrite.CompositeARGBSamplerConverter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CompositeARGBSamplerConverter_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.imglib2.Sampler",
      "net.imglib2.converter.readwrite.CompositeARGBSamplerConverter$CompositeRGBAccess",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CompositeARGBSamplerConverter_ESTest_scaffolding.class.getClassLoader()); 
