...
public class WriteConvertedCursor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.converter.readwrite.WriteConvertedCursor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(WriteConvertedCursor_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Supplier", false, WriteConvertedCursor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.Cursor", false, WriteConvertedCursor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.converter.readwrite.CompositeARGBSamplerConverter", false, WriteConvertedCursor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.converter.readwrite.SamplerConverter", false, WriteConvertedCursor_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(WriteConvertedCursor_ESTest_scaffolding.class.getClassLoader()); 
