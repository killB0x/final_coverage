...
public class AbstractConvertedRealRandomAccessible_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.converter.AbstractConvertedRealRandomAccessible"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AbstractConvertedRealRandomAccessible_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiConsumer", false, AbstractConvertedRealRandomAccessible_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Supplier", false, AbstractConvertedRealRandomAccessible_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.converter.BiConverter", false, AbstractConvertedRealRandomAccessible_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.converter.Converter", false, AbstractConvertedRealRandomAccessible_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.interpolation.InterpolatorFactory", false, AbstractConvertedRealRandomAccessible_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AbstractConvertedRealRandomAccessible_ESTest_scaffolding.class.getClassLoader()); 
    ...
    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      ...
      "net.imglib2.converter.ComplexImaginaryFloatConverter",
