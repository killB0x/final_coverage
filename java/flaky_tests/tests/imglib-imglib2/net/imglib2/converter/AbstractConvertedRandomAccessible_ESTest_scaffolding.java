...
public class AbstractConvertedRandomAccessible_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.converter.AbstractConvertedRandomAccessible"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AbstractConvertedRandomAccessible_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiConsumer", false, AbstractConvertedRandomAccessible_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Supplier", false, AbstractConvertedRandomAccessible_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.converter.BiConverter", false, AbstractConvertedRandomAccessible_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.converter.Converter", false, AbstractConvertedRandomAccessible_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.converter.readwrite.SamplerConverter", false, AbstractConvertedRandomAccessible_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AbstractConvertedRandomAccessible_ESTest_scaffolding.class.getClassLoader()); 
