...
public class ConvertedRealRandomAccess_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.converter.read.ConvertedRealRandomAccess"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ConvertedRealRandomAccess_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Supplier", false, ConvertedRealRandomAccess_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.converter.Converter", false, ConvertedRealRandomAccess_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ConvertedRealRandomAccess_ESTest_scaffolding.class.getClassLoader()); 
