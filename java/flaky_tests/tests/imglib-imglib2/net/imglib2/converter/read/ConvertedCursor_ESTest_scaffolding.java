...
public class ConvertedCursor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.converter.read.ConvertedCursor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ConvertedCursor_ESTest_scaffolding.class.getClassLoader() ,
      "net.imglib2.Point",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Supplier", false, ConvertedCursor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.Cursor", false, ConvertedCursor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.converter.Converter", false, ConvertedCursor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.view.composite.GenericComposite", false, ConvertedCursor_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ConvertedCursor_ESTest_scaffolding.class.getClassLoader()); 
    ...
    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      ...
      "net.imglib2.converter.ComplexRealFloatConverter",
      ...
      "net.imglib2.converter.RealFloatConverter",
      "net.imglib2.type.numeric.integer.UnsignedByteType",
      "net.imglib2.converter.ComplexPhaseFloatConverter",
