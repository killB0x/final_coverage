...
public class BiConvertedRealRandomAccess_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.converter.read.BiConvertedRealRandomAccess"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BiConvertedRealRandomAccess_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Supplier", false, BiConvertedRealRandomAccess_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.converter.BiConverter", false, BiConvertedRealRandomAccess_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BiConvertedRealRandomAccess_ESTest_scaffolding.class.getClassLoader()); 
