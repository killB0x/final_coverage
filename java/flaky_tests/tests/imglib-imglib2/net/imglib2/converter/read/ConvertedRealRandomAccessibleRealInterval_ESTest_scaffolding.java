...
public class ConvertedRealRandomAccessibleRealInterval_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.converter.read.ConvertedRealRandomAccessibleRealInterval"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ConvertedRealRandomAccessibleRealInterval_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Supplier", false, ConvertedRealRandomAccessibleRealInterval_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.RealRandomAccessibleRealInterval", false, ConvertedRealRandomAccessibleRealInterval_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.converter.Converter", false, ConvertedRealRandomAccessibleRealInterval_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ConvertedRealRandomAccessibleRealInterval_ESTest_scaffolding.class.getClassLoader()); 
