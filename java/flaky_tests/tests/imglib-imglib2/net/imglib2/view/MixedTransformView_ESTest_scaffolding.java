...
public class MixedTransformView_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.view.MixedTransformView"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MixedTransformView_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Function", false, MixedTransformView_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.RandomAccessible", false, MixedTransformView_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MixedTransformView_ESTest_scaffolding.class.getClassLoader()); 
