...
public class GenericComposite_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.view.composite.GenericComposite"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GenericComposite_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.imglib2.view.composite.GenericComposite$Factory",
      "net.imglib2.Point",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Supplier", false, GenericComposite_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GenericComposite_ESTest_scaffolding.class.getClassLoader()); 
