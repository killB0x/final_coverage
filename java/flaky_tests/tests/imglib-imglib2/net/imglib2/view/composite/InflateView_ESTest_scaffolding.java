...
public class InflateView_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.view.composite.InflateView"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(InflateView_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiConsumer", false, InflateView_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Supplier", false, InflateView_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.outofbounds.OutOfBoundsFactory", false, InflateView_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.view.composite.Composite", false, InflateView_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(InflateView_ESTest_scaffolding.class.getClassLoader()); 
