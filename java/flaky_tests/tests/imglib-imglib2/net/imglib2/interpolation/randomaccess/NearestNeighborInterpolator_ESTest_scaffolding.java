...
public class NearestNeighborInterpolator_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.interpolation.randomaccess.NearestNeighborInterpolator"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NearestNeighborInterpolator_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiConsumer", false, NearestNeighborInterpolator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Supplier", false, NearestNeighborInterpolator_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.interpolation.InterpolatorFactory", false, NearestNeighborInterpolator_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NearestNeighborInterpolator_ESTest_scaffolding.class.getClassLoader()); 
