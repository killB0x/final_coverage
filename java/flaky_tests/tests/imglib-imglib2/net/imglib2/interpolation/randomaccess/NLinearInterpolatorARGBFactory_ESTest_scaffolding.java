...
public class NLinearInterpolatorARGBFactory_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.interpolation.randomaccess.NLinearInterpolatorARGBFactory"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NLinearInterpolatorARGBFactory_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiConsumer", false, NLinearInterpolatorARGBFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Supplier", false, NLinearInterpolatorARGBFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.RealRandomAccessible", false, NLinearInterpolatorARGBFactory_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NLinearInterpolatorARGBFactory_ESTest_scaffolding.class.getClassLoader()); 
