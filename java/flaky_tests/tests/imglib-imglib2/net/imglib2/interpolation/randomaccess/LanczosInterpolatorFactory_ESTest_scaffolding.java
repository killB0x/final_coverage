...
public class LanczosInterpolatorFactory_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.interpolation.randomaccess.LanczosInterpolatorFactory"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LanczosInterpolatorFactory_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.BiConsumer", false, LanczosInterpolatorFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Supplier", false, LanczosInterpolatorFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.RealRandomAccessible", false, LanczosInterpolatorFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.img.basictypeaccess.DoubleAccess", false, LanczosInterpolatorFactory_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LanczosInterpolatorFactory_ESTest_scaffolding.class.getClassLoader()); 
