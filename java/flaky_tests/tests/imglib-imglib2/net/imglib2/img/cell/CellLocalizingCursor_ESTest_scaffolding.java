...
public class CellLocalizingCursor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.imglib2.img.cell.CellLocalizingCursor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CellLocalizingCursor_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.function.Consumer", false, CellLocalizingCursor_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.imglib2.img.cell.LazyCellImg$Get", false, CellLocalizingCursor_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CellLocalizingCursor_ESTest_scaffolding.class.getClassLoader()); 
