...
public class AbstractSerializer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.sf.sojo.interchange.AbstractSerializer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AbstractSerializer_ESTest_scaffolding.class.getClassLoader() ,
      "net.sf.sojo.core.SimpleConversion",
      "net.sf.sojo.common.ObjectUtil",
      "net.sf.sojo.core.reflect.ReflectionFieldHelper",
      "net.sf.sojo.interchange.csv.CsvParser",
      "net.sf.sojo.interchange.json.generate.ParseException",
      "net.sf.sojo.interchange.json.generate.Token",
      "net.sf.sojo.interchange.csv.CsvParserException",
      ...
      "net.sf.sojo.interchange.json.JsonParser",
      "net.sf.sojo.interchange.json.generate.JsonParserGenerate$LookaheadSuccess",
      "net.sf.sojo.core.ConversionException",
      "net.sf.sojo.interchange.xmlrpc.XmlRpcWalkerInterceptor",
      ...
      "net.sf.sojo.interchange.json.generate.JsonParserGenerate",
      "net.sf.sojo.interchange.json.generate.SimpleCharStream",
      "net.sf.sojo.core.ConversionContext",
      "net.sf.sojo.core.reflect.ClassPropertiesCache",
      "net.sf.sojo.util.Table",
      "net.sf.sojo.common.CompareResult",
      "net.sf.sojo.interchange.Serializer",
      "net.sf.sojo.interchange.json.generate.TokenMgrError",
      "net.sf.sojo.interchange.csv.CsvWalkerInterceptor",
      "net.sf.sojo.core.reflect.AccessiblePrivilegedAction",
      "net.sf.sojo.interchange.xmlrpc.XmlRpcParser",
      "net.sf.sojo.interchange.xmlrpc.XmlRpcSerializer",
      "net.sf.sojo.core.conversion.Iterateable2IterateableConversion",
      "net.sf.sojo.core.filter.ClassPropertyFilter",
      "net.sf.sojo.interchange.json.JsonWalkerInterceptor",
      ...
      "net.sf.sojo.interchange.AbstractSerializer",
      ...
      "net.sf.sojo.interchange.json.generate.JsonParserGenerate$JJCalls",
      ...
      "net.sf.sojo.interchange.json.generate.JsonParserGenerateConstants",
      "net.sf.sojo.core.ConverterInterceptor",
      "net.sf.sojo.interchange.json.generate.JsonParserGenerateTokenManager",
      ...
      "net.sf.sojo.interchange.object.ObjectSerializer",
      "net.sf.sojo.interchange.csv.CsvSerializer",
      "net.sf.sojo.util.CycleDetector",
      "net.sf.sojo.interchange.xmlrpc.XmlRpcException",
      "net.sf.sojo.common.ObjectGraphWalker",
      "net.sf.sojo.interchange.SerializerException",
      "net.sf.sojo.interchange.json.JsonSerializer",
      "net.sf.sojo.core.ComplexConversion"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AbstractSerializer_ESTest_scaffolding.class.getClassLoader()); 
    ...
    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      ...
      "net.sf.sojo.interchange.xmlrpc.XmlRpcContentHandler",
      "net.sf.sojo.interchange.xmlrpc.XmlRpcException"
    );
  }
}
