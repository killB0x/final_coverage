...
public class ConverterInterceptorHandler_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.sf.sojo.core.ConverterInterceptorHandler"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ConverterInterceptorHandler_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.sf.sojo.util.StackTraceElementWrapper",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ConverterInterceptorHandler_ESTest_scaffolding.class.getClassLoader()); 
