...
public class Core_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "uk.ziglio.construct.Core"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Core_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("uk.ziglio.construct.interfaces.CountFunc", false, Core_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ziglio.construct.lib.Decoder", false, Core_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ziglio.construct.lib.Encoder", false, Core_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ziglio.construct.lib.Resizer", false, Core_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Core_ESTest_scaffolding.class.getClassLoader()); 
