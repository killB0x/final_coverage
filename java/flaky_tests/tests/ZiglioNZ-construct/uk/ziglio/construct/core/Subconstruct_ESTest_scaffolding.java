...
public class Subconstruct_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "uk.ziglio.construct.core.Subconstruct"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Subconstruct_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("uk.ziglio.construct.core.KeyFunc", false, Subconstruct_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("uk.ziglio.construct.lib.Resizer", false, Subconstruct_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Subconstruct_ESTest_scaffolding.class.getClassLoader()); 
