...
public class DeclaredMethodCacheEntryFactory_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "ognl.internal.entry.DeclaredMethodCacheEntryFactory"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DeclaredMethodCacheEntryFactory_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DeclaredMethodCacheEntryFactory_ESTest_scaffolding.class.getClassLoader()); 
