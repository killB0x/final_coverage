...
public class XMLParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.addition.epanet.network.io.input.XMLParser"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.thoughtworks.xstream.converters.MarshallingContext", false, XMLParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.thoughtworks.xstream.converters.UnmarshallingContext", false, XMLParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.thoughtworks.xstream.io.HierarchicalStreamReader", false, XMLParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.thoughtworks.xstream.io.HierarchicalStreamWriter", false, XMLParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.io.File", false, XMLParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.logging.Logger", false, XMLParser_ESTest_scaffolding.class.getClassLoader()));
  }
