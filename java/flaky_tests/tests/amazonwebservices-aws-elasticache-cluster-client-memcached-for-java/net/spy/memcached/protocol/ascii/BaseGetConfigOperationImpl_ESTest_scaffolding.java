...
public class BaseGetConfigOperationImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.spy.memcached.protocol.ascii.BaseGetConfigOperationImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BaseGetConfigOperationImpl_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.spy.memcached.protocol.ascii.BaseGetConfigOperationImpl$1",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.spy.memcached.ops.GetConfigOperation$Callback", false, BaseGetConfigOperationImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BaseGetConfigOperationImpl_ESTest_scaffolding.class.getClassLoader()); 
