...
public class BinaryOperationFactory_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.spy.memcached.protocol.binary.BinaryOperationFactory"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BinaryOperationFactory_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.spy.memcached.ops.GetAndTouchOperation$Callback", false, BinaryOperationFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.GetlOperation$Callback", false, BinaryOperationFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.ObserveOperation$Callback", false, BinaryOperationFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.OperationCallback", false, BinaryOperationFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.ReplicaGetsOperation$Callback", false, BinaryOperationFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.StatsOperation$Callback", false, BinaryOperationFactory_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.StoreOperation$Callback", false, BinaryOperationFactory_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BinaryOperationFactory_ESTest_scaffolding.class.getClassLoader()); 
