...
public class BaseOperationImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.spy.memcached.protocol.BaseOperationImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BaseOperationImpl_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.spy.memcached.ops.GetAndTouchOperation$Callback", false, BaseOperationImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.OperationCallback", false, BaseOperationImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.ReplicaGetsOperation$Callback", false, BaseOperationImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.StatsOperation$Callback", false, BaseOperationImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BaseOperationImpl_ESTest_scaffolding.class.getClassLoader()); 
