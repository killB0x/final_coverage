...
public class SingleKeyOperationImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.spy.memcached.protocol.binary.SingleKeyOperationImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SingleKeyOperationImpl_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.spy.memcached.ops.GetAndTouchOperation$Callback", false, SingleKeyOperationImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.OperationCallback", false, SingleKeyOperationImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.StatsOperation$Callback", false, SingleKeyOperationImpl_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.StoreOperation$Callback", false, SingleKeyOperationImpl_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SingleKeyOperationImpl_ESTest_scaffolding.class.getClassLoader()); 
