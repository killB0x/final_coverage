...
public class OperationFuture_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.spy.memcached.internal.OperationFuture"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OperationFuture_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.spy.memcached.MemcachedClient$19",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.spy.memcached.BroadcastOpFactory", false, OperationFuture_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.internal.OperationCompletionListener", false, OperationFuture_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.spy.memcached.ops.StatsOperation$Callback", false, OperationFuture_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OperationFuture_ESTest_scaffolding.class.getClassLoader()); 
