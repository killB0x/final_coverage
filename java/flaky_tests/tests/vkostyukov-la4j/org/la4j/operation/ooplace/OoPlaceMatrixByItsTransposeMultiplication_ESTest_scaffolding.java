...
public class OoPlaceMatrixByItsTransposeMultiplication_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.la4j.operation.ooplace.OoPlaceMatrixByItsTransposeMultiplication"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OoPlaceMatrixByItsTransposeMultiplication_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OoPlaceMatrixByItsTransposeMultiplication_ESTest_scaffolding.class.getClassLoader()); 
