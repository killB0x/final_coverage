...
public class DataClayPredicate_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "es.bsc.dataclay.util.filtering.DataClayPredicate"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DataClayPredicate_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.ListIterator", false, DataClayPredicate_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DataClayPredicate_ESTest_scaffolding.class.getClassLoader()); 

    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      "es.bsc.dataclay.util.filtering.DataClayPredicate",
      "es.bsc.dataclay.util.filtering.Condition$ConditionOp",
      "es.bsc.dataclay.exceptions.ErrorDefs$ERRORCODE",
      "es.bsc.dataclay.util.filtering.DataClayPredicate$1",
      "es.bsc.dataclay.serialization.buffer.JavaByteBuffer",
