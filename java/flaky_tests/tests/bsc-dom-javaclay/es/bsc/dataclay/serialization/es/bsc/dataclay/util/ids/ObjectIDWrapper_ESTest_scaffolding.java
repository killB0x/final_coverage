...
public class ObjectIDWrapper_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "es.bsc.dataclay.serialization.es.bsc.dataclay.util.ids.ObjectIDWrapper"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ObjectIDWrapper_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "es.bsc.dataclay.serialization.es.bsc.dataclay.util.ids.ObjectIDWrapper",
      "es.bsc.dataclay.serialization.java.DataClayJavaWrapper"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.ListIterator", false, ObjectIDWrapper_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ObjectIDWrapper_ESTest_scaffolding.class.getClassLoader()); 
