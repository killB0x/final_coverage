...
public class DataClayInstanceIDWrapper_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "es.bsc.dataclay.serialization.es.bsc.dataclay.util.ids.DataClayInstanceIDWrapper"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DataClayInstanceIDWrapper_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "es.bsc.dataclay.serialization.es.bsc.dataclay.util.ids.DataClayInstanceIDWrapper",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.ListIterator", false, DataClayInstanceIDWrapper_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DataClayInstanceIDWrapper_ESTest_scaffolding.class.getClassLoader()); 
