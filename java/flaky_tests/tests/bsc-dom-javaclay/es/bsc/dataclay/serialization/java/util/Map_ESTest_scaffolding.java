...
public class Map_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "es.bsc.dataclay.serialization.java.util.Map"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Map_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "es.bsc.dataclay.serialization.java.util.Map",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.ListIterator", false, Map_ESTest_scaffolding.class.getClassLoader()));
  }
