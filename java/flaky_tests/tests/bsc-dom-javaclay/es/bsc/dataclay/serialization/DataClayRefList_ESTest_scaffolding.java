...
public class DataClayRefList_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "es.bsc.dataclay.serialization.DataClayRefList"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DataClayRefList_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "es.bsc.dataclay.serialization.DataClayRefList",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.ListIterator", false, DataClayRefList_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DataClayRefList_ESTest_scaffolding.class.getClassLoader()); 
