...
public class AtomicIntegerWrapper_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "es.bsc.dataclay.serialization.java.util.concurrent.atomic.AtomicIntegerWrapper"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AtomicIntegerWrapper_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "es.bsc.dataclay.serialization.java.util.concurrent.atomic.AtomicIntegerWrapper",
      "es.bsc.dataclay.serialization.java.DataClayJavaWrapper"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.util.ListIterator", false, AtomicIntegerWrapper_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AtomicIntegerWrapper_ESTest_scaffolding.class.getClassLoader()); 
