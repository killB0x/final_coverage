...
public class DataContractManager_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "es.bsc.dataclay.logic.datacontractmgr.DataContractManager"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DataContractManager_ESTest_scaffolding.class.getClassLoader() ,
      "es.bsc.dataclay.exceptions.logicmodule.datacontractmgr.AccountHasNoDataContractWithProvider",
      "es.bsc.dataclay.logic.datacontractmgr.DataContractManagerDB",
      "es.bsc.dataclay.logic.datacontractmgr.DataContractManager",
      "es.bsc.dataclay.util.ids.ID",
      "es.bsc.dataclay.exceptions.logicmodule.datacontractmgr.DataContractNotActiveException",
      "es.bsc.dataclay.exceptions.logicmodule.datacontractmgr.DataContractNotPublicException",
      "es.bsc.dataclay.exceptions.dbhandler.DbObjectAlreadyExistException",
      "es.bsc.dataclay.util.ids.DataContractID",
      "es.bsc.dataclay.util.Configuration",
      "es.bsc.dataclay.util.CommonManager",
      "es.bsc.dataclay.exceptions.logicmodule.datacontractmgr.DataContractNotExistException",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DataContractManager_ESTest_scaffolding.class.getClassLoader()); 
