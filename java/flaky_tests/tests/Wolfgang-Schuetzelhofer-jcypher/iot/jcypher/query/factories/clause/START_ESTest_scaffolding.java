...
public class START_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "iot.jcypher.query.factories.clause.START"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(START_ESTest_scaffolding.class.getClassLoader() ,
      "iot.jcypher.query.values.JcValue",
      "iot.jcypher.query.api.IClause",
      "iot.jcypher.query.values.IHas",
      "iot.jcypher.query.factories.clause.START",
      ...
      "iot.jcypher.query.api.start.SFactory",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(START_ESTest_scaffolding.class.getClassLoader()); 
