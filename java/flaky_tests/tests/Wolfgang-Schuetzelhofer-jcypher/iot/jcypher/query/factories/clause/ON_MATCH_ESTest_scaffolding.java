...
public class ON_MATCH_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "iot.jcypher.query.factories.clause.ON_MATCH"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ON_MATCH_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "iot.jcypher.query.factories.clause.ON_MATCH",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ON_MATCH_ESTest_scaffolding.class.getClassLoader()); 
