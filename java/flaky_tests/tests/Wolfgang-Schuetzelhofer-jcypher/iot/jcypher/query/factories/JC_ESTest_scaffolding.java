...
public class JC_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "iot.jcypher.query.factories.JC"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(JC_ESTest_scaffolding.class.getClassLoader() ,
      "iot.jcypher.query.values.JcValue",
      "iot.jcypher.query.factories.JC",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(JC_ESTest_scaffolding.class.getClassLoader()); 
