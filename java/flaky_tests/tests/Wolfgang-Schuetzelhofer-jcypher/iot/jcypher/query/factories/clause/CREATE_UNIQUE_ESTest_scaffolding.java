...
public class CREATE_UNIQUE_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "iot.jcypher.query.factories.clause.CREATE_UNIQUE"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CREATE_UNIQUE_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "iot.jcypher.query.factories.clause.CREATE_UNIQUE",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CREATE_UNIQUE_ESTest_scaffolding.class.getClassLoader()); 
