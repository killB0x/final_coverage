...
public class WITH_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "iot.jcypher.query.factories.clause.WITH"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("iot.jcypher.query.api.collection.ICollectExpression", false, WITH_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("iot.jcypher.query.api.predicate.Concatenator", false, WITH_ESTest_scaffolding.class.getClassLoader()));
  }
