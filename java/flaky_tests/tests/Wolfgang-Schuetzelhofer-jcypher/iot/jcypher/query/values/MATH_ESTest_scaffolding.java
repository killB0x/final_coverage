...
public class MATH_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "iot.jcypher.query.values.MATH"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MATH_ESTest_scaffolding.class.getClassLoader() ,
      "iot.jcypher.query.values.JcValue",
      "iot.jcypher.query.values.Atan2",
      "iot.jcypher.query.values.IFragment",
      "iot.jcypher.query.values.JcString",
      "iot.jcypher.query.values.MathFunctions",
      "iot.jcypher.query.values.MATH",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MATH_ESTest_scaffolding.class.getClassLoader()); 
