...
public class SNodeOrRelation_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "iot.jcypher.query.api.start.SNodeOrRelation"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SNodeOrRelation_ESTest_scaffolding.class.getClassLoader() ,
      "iot.jcypher.query.values.JcValue",
      "iot.jcypher.query.api.IClause",
      "iot.jcypher.query.ast.start.IndexOrId",
      "iot.jcypher.query.values.IHas",
      "iot.jcypher.query.api.start.StartPoint",
      "iot.jcypher.query.ast.start.StartExpression",
      ...
      "iot.jcypher.query.api.start.SNodeOrRelation",
      "iot.jcypher.query.values.JcPrimitive",
      "iot.jcypher.query.api.APIObject",
      "iot.jcypher.query.api.start.SPropertyOrQuery",
      ...
      "iot.jcypher.query.api.start.SPropertyValue",
      "iot.jcypher.query.values.IOperatorOrFunction",
      "iot.jcypher.query.values.JcNode",
      "iot.jcypher.query.values.JcCollection",
      "iot.jcypher.query.ast.start.PropertyOrQuery"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SNodeOrRelation_ESTest_scaffolding.class.getClassLoader()); 
