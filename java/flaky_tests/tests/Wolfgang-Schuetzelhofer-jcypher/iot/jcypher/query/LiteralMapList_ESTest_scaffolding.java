...
public class LiteralMapList_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "iot.jcypher.query.LiteralMapList"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(LiteralMapList_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "iot.jcypher.query.LiteralMapList",
      "iot.jcypher.query.LiteralMap",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(LiteralMapList_ESTest_scaffolding.class.getClassLoader()); 
