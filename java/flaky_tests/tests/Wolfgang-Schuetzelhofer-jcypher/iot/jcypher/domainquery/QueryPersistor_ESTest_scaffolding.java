...
public class QueryPersistor_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "iot.jcypher.domainquery.QueryPersistor"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(QueryPersistor_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "iot.jcypher.domainquery.QueryMemento",
      ...
      "iot.jcypher.domainquery.internal.JSONConverter",
      "iot.jcypher.domainquery.internal.RecordedQueryToString"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(QueryPersistor_ESTest_scaffolding.class.getClassLoader()); 
