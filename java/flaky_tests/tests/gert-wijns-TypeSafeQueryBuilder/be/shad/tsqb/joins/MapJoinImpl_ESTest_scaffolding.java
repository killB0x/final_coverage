...
public class MapJoinImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "be.shad.tsqb.joins.MapJoinImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(MapJoinImpl_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "be.shad.tsqb.joins.MapJoinImpl",
      ...
      "be.shad.tsqb.joins.MapJoinInternal",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(MapJoinImpl_ESTest_scaffolding.class.getClassLoader()); 
