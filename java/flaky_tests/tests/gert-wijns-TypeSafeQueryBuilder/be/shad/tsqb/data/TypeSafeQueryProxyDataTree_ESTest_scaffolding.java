...
public class TypeSafeQueryProxyDataTree_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "be.shad.tsqb.data.TypeSafeQueryProxyDataTree"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TypeSafeQueryProxyDataTree_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "be.shad.tsqb.selection.group.TypeSafeQuerySelectionGroupImpl",
      "be.shad.tsqb.query.TypeSafeSubQuery",
      "be.shad.tsqb.helper.BuildFn",
      ...
      "be.shad.tsqb.helper.SelectionBuilderSpec",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("be.shad.tsqb.helper.BuildFn", false, TypeSafeQueryProxyDataTree_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("be.shad.tsqb.proxy.TypeSafeQueryProxy", false, TypeSafeQueryProxyDataTree_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.util.function.Supplier", false, TypeSafeQueryProxyDataTree_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TypeSafeQueryProxyDataTree_ESTest_scaffolding.class.getClassLoader()); 
    ...
    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      ...
      "be.shad.tsqb.data.TypeSafeQueryProxyData$1",
