...
public class OnGoingNumberRestrictionImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "be.shad.tsqb.restrictions.OnGoingNumberRestrictionImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(OnGoingNumberRestrictionImpl_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(OnGoingNumberRestrictionImpl_ESTest_scaffolding.class.getClassLoader()); 
