...
public class RestrictionsGroupImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "be.shad.tsqb.restrictions.RestrictionsGroupImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RestrictionsGroupImpl_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "be.shad.tsqb.restrictions.ContinuedOnGoingTextRestriction",
      "be.shad.tsqb.restrictions.ContinuedOnGoingEnumRestriction",
      "be.shad.tsqb.restrictions.OnGoingLocalDateRestrictionImpl",
      "be.shad.tsqb.restrictions.ContinuedOnGoingNumberRestriction",
      "be.shad.tsqb.restrictions.RestrictionsGroup",
      "be.shad.tsqb.proxy.TypeSafeQuerySelectionProxy",
      "be.shad.tsqb.query.TypeSafeBaseQuery",
      "be.shad.tsqb.restrictions.ContinuedOnGoingObjectRestriction",
      "be.shad.tsqb.restrictions.DirectValueProvider",
      "be.shad.tsqb.restrictions.RestrictionsGroupImpl$1",
      "be.shad.tsqb.query.TypeSafeRootQueryImpl",
      "be.shad.tsqb.selection.parallel.MapSelectionMerger",
      ...
      "be.shad.tsqb.selection.SelectionValueTransformer",
      "be.shad.tsqb.query.TypeSafeNameds",
      "be.shad.tsqb.restrictions.ContinuedOnGoingLocalDateRestriction",
      ...
      "be.shad.tsqb.selection.parallel.SelectTriplet",
      ...
      "be.shad.tsqb.selection.parallel.SelectionMerger2",
      "be.shad.tsqb.selection.parallel.SelectionMerger1",
      ...
      "be.shad.tsqb.proxy.TypeSafeQueryProxyType",
      ...
      "be.shad.tsqb.proxy.TypeSafeQueryProxy",
      "be.shad.tsqb.query.TypeSafeSubQuery",
      "be.shad.tsqb.values.arithmetic.ArithmeticGroupFunctions",
      "be.shad.tsqb.restrictions.ContinuedOnGoingDateRestriction",
      ...
      "be.shad.tsqb.selection.collection.ResultIdentifierBinder",
      ...
      "be.shad.tsqb.selection.parallel.SelectValue",
      ...
      "be.shad.tsqb.data.TypeSafeQuerySelectionProxyPropertyData",
      ...
      "be.shad.tsqb.restrictions.predicate.RestrictionGuard",
      ...
      "be.shad.tsqb.selection.parallel.SelectPair",
      ...
      "be.shad.tsqb.restrictions.ContinuedOnGoingBooleanRestriction",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RestrictionsGroupImpl_ESTest_scaffolding.class.getClassLoader()); 
