...
public class TypeSafeValueFunctions_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "be.shad.tsqb.values.TypeSafeValueFunctions"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TypeSafeValueFunctions_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "be.shad.tsqb.values.partial.PartialNullIf",
      "be.shad.tsqb.values.TypeSafeValueFunctions"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TypeSafeValueFunctions_ESTest_scaffolding.class.getClassLoader()); 
