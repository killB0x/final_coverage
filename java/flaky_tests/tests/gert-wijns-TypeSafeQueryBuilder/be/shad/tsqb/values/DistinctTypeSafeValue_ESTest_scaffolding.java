...
public class DistinctTypeSafeValue_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "be.shad.tsqb.values.DistinctTypeSafeValue"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DistinctTypeSafeValue_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("be.shad.tsqb.query.TypeSafeQueryScopeValidator", false, DistinctTypeSafeValue_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DistinctTypeSafeValue_ESTest_scaffolding.class.getClassLoader()); 
