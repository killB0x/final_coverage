...
public class FunctionTypeSafeValue_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "be.shad.tsqb.values.FunctionTypeSafeValue"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FunctionTypeSafeValue_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("be.shad.tsqb.query.TypeSafeQueryScopeValidator", false, FunctionTypeSafeValue_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FunctionTypeSafeValue_ESTest_scaffolding.class.getClassLoader()); 
