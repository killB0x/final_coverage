...
public class TypeSafeQueryOrderBys_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "be.shad.tsqb.ordering.TypeSafeQueryOrderBys"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TypeSafeQueryOrderBys_ESTest_scaffolding.class.getClassLoader() ,
      "be.shad.tsqb.ordering.OnGoingOrderBy",
      "be.shad.tsqb.query.TypeSafeRootQuery",
      "be.shad.tsqb.values.HqlQueryValueImpl",
      "be.shad.tsqb.ordering.OrderByProjection",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TypeSafeQueryOrderBys_ESTest_scaffolding.class.getClassLoader()); 
