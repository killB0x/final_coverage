...
public class TypeSafeNamedsImpl_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "be.shad.tsqb.query.TypeSafeNamedsImpl"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TypeSafeNamedsImpl_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "be.shad.tsqb.query.TypeSafeNamedsImpl",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TypeSafeNamedsImpl_ESTest_scaffolding.class.getClassLoader()); 
