...
public class RtfDestinationMgr_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.lowagie.text.rtf.parser.destinations.RtfDestinationMgr"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RtfDestinationMgr_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.lowagie.text.rtf.parser.destinations.RtfDestinationListener", false, RtfDestinationMgr_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RtfDestinationMgr_ESTest_scaffolding.class.getClassLoader()); 
