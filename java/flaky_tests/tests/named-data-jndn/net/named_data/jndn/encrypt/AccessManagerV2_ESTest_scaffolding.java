...
public class AccessManagerV2_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.encrypt.AccessManagerV2"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AccessManagerV2_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.named_data.jndn.encrypt.AccessManagerV2",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AccessManagerV2_ESTest_scaffolding.class.getClassLoader()); 

    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      "net.named_data.jndn.encrypt.AccessManagerV2",
      "net.named_data.jndn.encrypt.AccessManagerV2$1",
      "net.named_data.jndn.encrypt.AccessManagerV2$2",
      "net.named_data.jndn.Name$Component",
      "net.named_data.jndn.util.Blob",
      "net.named_data.jndn.ComponentType",
      "net.named_data.jndn.encrypt.EncryptorV2",
