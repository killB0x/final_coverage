...
public class DecryptorV2_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.encrypt.DecryptorV2"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(DecryptorV2_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.named_data.jndn.encrypt.DecryptorV2$ContentKey$PendingDecrypt",
      ...
      "net.named_data.jndn.encrypt.DecryptorV2$ContentKey",
      ...
      "net.named_data.jndn.encrypt.DecryptorV2$DecryptSuccessCallback",
      ...
      "net.named_data.jndn.encrypt.DecryptorV2",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.named_data.jndn.encrypt.DecryptorV2$DecryptSuccessCallback", false, DecryptorV2_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.encrypt.EncryptError$OnError", false, DecryptorV2_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(DecryptorV2_ESTest_scaffolding.class.getClassLoader()); 

    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      "net.named_data.jndn.encrypt.DecryptorV2",
      "net.named_data.jndn.encrypt.DecryptorV2$ContentKey",
      "net.named_data.jndn.encrypt.DecryptorV2$ContentKey$PendingDecrypt",
      "net.named_data.jndn.encrypt.DecryptorV2$1",
      "net.named_data.jndn.encrypt.DecryptorV2$2",
      "net.named_data.jndn.encrypt.DecryptorV2$3",
      "net.named_data.jndn.encrypt.DecryptorV2$4",
      "net.named_data.jndn.encrypt.DecryptorV2$5",
      "net.named_data.jndn.encrypt.DecryptorV2$6",
      "net.named_data.jndn.encrypt.EncryptError$ErrorCode",
      "net.named_data.jndn.KeyLocatorType",
      "net.named_data.jndn.Name$Component",
      "net.named_data.jndn.util.Blob",
