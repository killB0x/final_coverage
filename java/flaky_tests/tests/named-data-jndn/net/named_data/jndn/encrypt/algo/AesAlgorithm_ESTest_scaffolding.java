...
public class AesAlgorithm_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.encrypt.algo.AesAlgorithm"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AesAlgorithm_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.named_data.jndn.encrypt.EncryptKey",
      "net.named_data.jndn.Name$Component",
      "net.named_data.jndn.encrypt.algo.EncryptParams",
      "net.named_data.jndn.security.AesKeyParams",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AesAlgorithm_ESTest_scaffolding.class.getClassLoader()); 
