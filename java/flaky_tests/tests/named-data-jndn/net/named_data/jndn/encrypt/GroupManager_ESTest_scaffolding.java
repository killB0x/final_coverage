...
public class GroupManager_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.encrypt.GroupManager"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(GroupManager_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.named_data.jndn.encrypt.GroupManager$FriendAccess",
      "net.named_data.jndn.encoding.der.DerEncodingException",
      "net.named_data.jndn.encrypt.GroupManager$FriendAccessImpl",
      ...
      "net.named_data.jndn.encrypt.Schedule$Result",
      "net.named_data.jndn.encrypt.Interval",
      "net.named_data.jndn.encrypt.GroupManager$Friend",
      ...
      "net.named_data.jndn.encrypt.GroupManagerDb",
      ...
      "net.named_data.jndn.encrypt.GroupManagerDb$Error",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.named_data.jndn.encrypt.GroupManager$Friend", false, GroupManager_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(GroupManager_ESTest_scaffolding.class.getClassLoader()); 
    ...
    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      ...
      "net.named_data.jndn.util.Common",
      "net.named_data.jndn.encrypt.GroupManagerDb",
      "net.named_data.jndn.encrypt.Sqlite3GroupManagerDbBase",
      "net.named_data.jndn.encrypt.Sqlite3GroupManagerDb",
      "net.named_data.jndn.security.pib.PibImpl",
      ...
      "net.named_data.jndn.encrypt.RepetitiveInterval",
      "net.named_data.jndn.encrypt.RepetitiveInterval$RepeatUnit",
      ...
      "net.named_data.jndn.security.v2.CertificateV2$Error",
      "net.named_data.jndn.lp.LpPacket",
      "net.named_data.jndn.encrypt.RepetitiveInterval$Result",
