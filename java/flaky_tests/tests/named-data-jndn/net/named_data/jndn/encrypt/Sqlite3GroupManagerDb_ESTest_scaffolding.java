...
public class Sqlite3GroupManagerDb_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.encrypt.Sqlite3GroupManagerDb"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Sqlite3GroupManagerDb_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Sqlite3GroupManagerDb_ESTest_scaffolding.class.getClassLoader()); 
