...
public class Face_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.Face"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Face_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.named_data.jndn.security.v2.TrustAnchorContainer$Error",
      ...
      "net.named_data.jndn.security.certificate.CertificateSubjectDescription",
      "net.named_data.jndn.impl.DelayedCallTable",
      "net.named_data.jndn.encoding.der.DerEncodingException",
      "net.named_data.jndn.security.v2.InterestValidationFailureCallback",
      ...
      "net.named_data.jndn.Exclude$Entry",
      ...
      "net.named_data.jndn.security.v2.InterestValidationSuccessCallback",
      "net.named_data.jndn.util.MemoryContentCache$Content",
      ...
      "net.named_data.jndn.util.MemoryContentCache$StaleTimeContent",
      ...
      "net.named_data.jndn.security.policy.ConfigPolicyManager$FriendAccessImpl",
      "net.named_data.jndn.transport.TcpTransport$ConnectionInfo",
      "net.named_data.jndn.security.SigningInfo$SignerType",
      "net.named_data.jndn.security.v2.CertificateFetcher$ValidationContinuation",
      ...
      "net.named_data.jndn.security.policy.ConfigPolicyManager$Friend",
      ...
      "net.named_data.jndn.security.policy.ConfigPolicyManager$FriendAccess",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.named_data.jndn.Name$Component", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.OnData", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.OnNetworkNack", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.OnRegisterFailed", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.OnRegisterSuccess", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.OnTimeout", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.identity.IdentityManager", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.pib.PibImpl", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.policy.PolicyManager", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.tpm.TpmBackEnd", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.CertificateFetcher", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.InterestValidationFailureCallback", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.InterestValidationSuccessCallback", false, Face_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.ValidationPolicy", false, Face_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Face_ESTest_scaffolding.class.getClassLoader()); 
