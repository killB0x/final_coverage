...
public class ValidatorNull_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.security.ValidatorNull"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ValidatorNull_ESTest_scaffolding.class.getClassLoader() ,
      "net.named_data.jndn.util.Common$Base64ConverterType",
      "net.named_data.jndn.security.ValidatorNull",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ValidatorNull_ESTest_scaffolding.class.getClassLoader()); 
