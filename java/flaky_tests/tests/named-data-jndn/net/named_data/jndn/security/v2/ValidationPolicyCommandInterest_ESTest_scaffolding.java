...
public class ValidationPolicyCommandInterest_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.security.v2.ValidationPolicyCommandInterest"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ValidationPolicyCommandInterest_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.named_data.jndn.security.v2.DataValidationFailureCallback", false, ValidationPolicyCommandInterest_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.DataValidationSuccessCallback", false, ValidationPolicyCommandInterest_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.InterestValidationFailureCallback", false, ValidationPolicyCommandInterest_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.InterestValidationSuccessCallback", false, ValidationPolicyCommandInterest_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.ValidationPolicy$ValidationContinuation", false, ValidationPolicyCommandInterest_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ValidationPolicyCommandInterest_ESTest_scaffolding.class.getClassLoader()); 
    ...
    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      ...
      "net.named_data.jndn.security.v2.ValidationPolicyCommandInterest",
      "net.named_data.jndn.security.v2.ValidationPolicyCommandInterest$Options",
      "net.named_data.jndn.security.v2.ValidationPolicyCommandInterest$1",
      "net.named_data.jndn.security.v2.ValidationPolicyCommandInterest$LastTimestampRecord",
      "net.named_data.jndn.security.v2.ValidationPolicyAcceptAll",
