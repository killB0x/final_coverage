...
public class ValidationPolicyFromPib_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.security.v2.ValidationPolicyFromPib"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ValidationPolicyFromPib_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.named_data.jndn.security.v2.DataValidationFailureCallback", false, ValidationPolicyFromPib_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.DataValidationSuccessCallback", false, ValidationPolicyFromPib_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.InterestValidationFailureCallback", false, ValidationPolicyFromPib_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.InterestValidationSuccessCallback", false, ValidationPolicyFromPib_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.ValidationPolicy$ValidationContinuation", false, ValidationPolicyFromPib_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ValidationPolicyFromPib_ESTest_scaffolding.class.getClassLoader()); 
