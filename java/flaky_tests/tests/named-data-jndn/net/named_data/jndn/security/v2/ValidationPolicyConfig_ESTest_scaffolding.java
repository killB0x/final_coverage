...
public class ValidationPolicyConfig_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.security.v2.ValidationPolicyConfig"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ValidationPolicyConfig_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.named_data.jndn.security.v2.validator_config.ConfigRule",
      ...
      "net.named_data.jndn.util.BoostInfoTree$TreeEntry",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.named_data.jndn.security.v2.DataValidationFailureCallback", false, ValidationPolicyConfig_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.DataValidationSuccessCallback", false, ValidationPolicyConfig_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.InterestValidationFailureCallback", false, ValidationPolicyConfig_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.InterestValidationSuccessCallback", false, ValidationPolicyConfig_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.ValidationPolicy$ValidationContinuation", false, ValidationPolicyConfig_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ValidationPolicyConfig_ESTest_scaffolding.class.getClassLoader()); 

    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      "net.named_data.jndn.security.v2.ValidationPolicy",
      "net.named_data.jndn.security.v2.ValidationPolicyConfig",
      "net.named_data.jndn.security.v2.validator_config.ConfigNameRelation$Relation",
      "net.named_data.jndn.util.Common$Base64ConverterType",
      "net.named_data.jndn.util.Common",
      "net.named_data.jndn.util.BoostInfoTree",
      "net.named_data.jndn.security.ValidatorConfigError",
      ...
      "net.named_data.jndn.Exclude$Type",
      ...
      "net.named_data.jndn.security.v2.CertificateFetcherFromNetwork$1",
      "net.named_data.jndn.security.v2.CertificateFetcherFromNetwork$2",
      "net.named_data.jndn.security.v2.CertificateFetcherFromNetwork$3",
      "net.named_data.jndn.security.v2.CertificateFetcher$1",
      "net.named_data.jndn.security.pib.PibCertificateContainer",
      "net.named_data.jndn.encoding.der.DerNode$DerBitString",
      "net.named_data.jndn.security.identity.MemoryIdentityStorage$KeyRecord",
