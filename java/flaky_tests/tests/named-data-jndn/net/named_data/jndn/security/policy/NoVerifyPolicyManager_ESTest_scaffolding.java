...
public class NoVerifyPolicyManager_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.security.policy.NoVerifyPolicyManager"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NoVerifyPolicyManager_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.named_data.jndn.security.OnDataValidationFailed", false, NoVerifyPolicyManager_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.OnInterestValidationFailed", false, NoVerifyPolicyManager_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.OnVerified", false, NoVerifyPolicyManager_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.OnVerifiedInterest", false, NoVerifyPolicyManager_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NoVerifyPolicyManager_ESTest_scaffolding.class.getClassLoader()); 
