...
public class CommandInterestSigner_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.security.CommandInterestSigner"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CommandInterestSigner_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.named_data.jndn.security.CommandInterestSigner",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.named_data.jndn.security.pib.detail.PibKeyImpl", false, CommandInterestSigner_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CommandInterestSigner_ESTest_scaffolding.class.getClassLoader()); 
