...
public class TpmBackEndFile_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.security.tpm.TpmBackEndFile"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(TpmBackEndFile_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.named_data.jndn.security.tpm.TpmBackEndFile$Error",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.named_data.jndn.security.KeyParams", false, TpmBackEndFile_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(TpmBackEndFile_ESTest_scaffolding.class.getClassLoader()); 
