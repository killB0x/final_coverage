...
public class EcdsaKeyParams_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.security.EcdsaKeyParams"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(EcdsaKeyParams_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.named_data.jndn.security.EcdsaKeyParams",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(EcdsaKeyParams_ESTest_scaffolding.class.getClassLoader()); 
