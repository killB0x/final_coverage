...
public class ValidationPolicySimpleHierarchy_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.security.v2.ValidationPolicySimpleHierarchy"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ValidationPolicySimpleHierarchy_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.named_data.jndn.security.v2.DataValidationFailureCallback", false, ValidationPolicySimpleHierarchy_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.DataValidationSuccessCallback", false, ValidationPolicySimpleHierarchy_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.InterestValidationFailureCallback", false, ValidationPolicySimpleHierarchy_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.InterestValidationSuccessCallback", false, ValidationPolicySimpleHierarchy_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("net.named_data.jndn.security.v2.ValidationPolicy$ValidationContinuation", false, ValidationPolicySimpleHierarchy_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ValidationPolicySimpleHierarchy_ESTest_scaffolding.class.getClassLoader()); 
