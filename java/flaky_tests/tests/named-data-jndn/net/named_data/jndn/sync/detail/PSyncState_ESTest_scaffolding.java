...
public class PSyncState_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.sync.detail.PSyncState"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PSyncState_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.named_data.jndn.sync.detail.PSyncState",
      ...
      "net.named_data.jndn.encoding.Tlv0_2WireFormat",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PSyncState_ESTest_scaffolding.class.getClassLoader()); 
