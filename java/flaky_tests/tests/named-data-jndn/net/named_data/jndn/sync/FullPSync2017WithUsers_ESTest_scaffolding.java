...
public class FullPSync2017WithUsers_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.sync.FullPSync2017WithUsers"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FullPSync2017WithUsers_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.named_data.jndn.sync.PSyncMissingDataInfo",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("net.named_data.jndn.sync.FullPSync2017WithUsers$OnUpdate", false, FullPSync2017WithUsers_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FullPSync2017WithUsers_ESTest_scaffolding.class.getClassLoader()); 
