...
public class PSyncSegmentPublisher_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.sync.detail.PSyncSegmentPublisher"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(PSyncSegmentPublisher_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "net.named_data.jndn.sync.detail.PSyncSegmentPublisher$1"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(PSyncSegmentPublisher_ESTest_scaffolding.class.getClassLoader()); 
