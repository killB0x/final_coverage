...
public class AsyncTcpTransport_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "net.named_data.jndn.transport.AsyncTcpTransport"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AsyncTcpTransport_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AsyncTcpTransport_ESTest_scaffolding.class.getClassLoader()); 
    ...
    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      ...
      "net.named_data.jndn.transport.Transport$ConnectionInfo",
      "net.named_data.jndn.transport.AsyncTcpTransport$ConnectionInfo",
      "net.named_data.jndn.transport.AsyncTcpTransport$3",
      "net.named_data.jndn.transport.AsyncTcpTransport$4",
      "net.named_data.jndn.transport.AsyncTcpTransport$5",
      "net.named_data.jndn.transport.TcpTransport",
      "net.named_data.jndn.util.Blob",
      "net.named_data.jndn.Node",
      "net.named_data.jndn.impl.PendingInterestTable",
