...
public class ThrowAnswer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "se.mockachino.stub.exception.ThrowAnswer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ThrowAnswer_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "se.mockachino.proxy.ObjenesisUtil",
      "se.mockachino.cleaner.StacktraceCleaner$1"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ThrowAnswer_ESTest_scaffolding.class.getClassLoader()); 
