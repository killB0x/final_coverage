...
public class Settings_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "se.mockachino.Settings"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("se.mockachino.CallHandler", false, Settings_ESTest_scaffolding.class.getClassLoader()));
  }
