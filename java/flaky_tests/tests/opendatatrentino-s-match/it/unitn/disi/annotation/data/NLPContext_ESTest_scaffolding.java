...
public class NLPContext_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "it.unitn.disi.annotation.data.NLPContext"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(NLPContext_ESTest_scaffolding.class.getClassLoader() ,
      "it.unitn.disi.smatch.data.trees.INodeData",
      "it.unitn.disi.annotation.data.NLPContext",
      ...
      "it.unitn.disi.nlptools.data.ILabel",
      "it.unitn.disi.smatch.data.trees.IBaseTreeStructureChangedListener",
      "it.unitn.disi.annotation.data.INLPNodeData",
      "it.unitn.disi.annotation.data.INLPNode",
      "it.unitn.disi.annotation.data.NLPNode",
      "it.unitn.disi.annotation.data.INLPContext",
      "it.unitn.disi.smatch.data.trees.Node"
    );
  } 

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(NLPContext_ESTest_scaffolding.class.getClassLoader()); 
    ...
    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      ...
      "it.unitn.disi.nlptools.data.Label",
