...
public class XMLUtil_ESTest extends XMLUtil_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      XmlElement xmlElement0 = XMLUtil.makeXmlTag("", "Ve(QsCNy");
      assertNotNull(xmlElement0);
  }

  @Test(timeout = 4000)
  public void test01()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode("%IkmL{BdhBc0t'6q=N");
      IIOMetadataNode iIOMetadataNode1 = (IIOMetadataNode)iIOMetadataNode0.removeChild(iIOMetadataNode0);
      Element element0 = XMLUtil.getOnlyChildElement(iIOMetadataNode1);
      assertNull(element0);
  }
  ...
  public void test05()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode("6B=yi$y");
      NodeList nodeList0 = iIOMetadataNode0.getElementsByTagNameNS("6B=yi$y", "6B=yi$y");
  ...
  public void test07()  throws Throwable  {
      ...
      try { 
        XMLUtil.getOnlyTextContent(nodeList0);
  ...
  public void test09()  throws Throwable  {
      IIOMetadataNode iIOMetadataNode0 = new IIOMetadataNode("{Uq?i;+s");
      IIOMetadataNode iIOMetadataNode1 = new IIOMetadataNode("{Uq?i;+s");
      iIOMetadataNode0.appendChild(iIOMetadataNode1);
      NodeList nodeList0 = iIOMetadataNode0.getElementsByTagName("{Uq?i;+s");
      try { 
