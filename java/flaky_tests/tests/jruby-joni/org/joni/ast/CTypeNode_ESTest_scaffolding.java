...
public class CTypeNode_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.joni.ast.CTypeNode"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CTypeNode_ESTest_scaffolding.class.getClassLoader() ,
      "org.joni.ast.Node",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CTypeNode_ESTest_scaffolding.class.getClassLoader()); 
