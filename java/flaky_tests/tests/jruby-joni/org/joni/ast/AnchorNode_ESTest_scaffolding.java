...
public class AnchorNode_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.joni.ast.AnchorNode"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AnchorNode_ESTest_scaffolding.class.getClassLoader() ,
      "org.joni.ast.Node",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AnchorNode_ESTest_scaffolding.class.getClassLoader()); 
