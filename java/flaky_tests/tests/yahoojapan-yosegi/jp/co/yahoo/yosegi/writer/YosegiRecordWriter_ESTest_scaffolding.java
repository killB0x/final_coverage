...
public class YosegiRecordWriter_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "jp.co.yahoo.yosegi.writer.YosegiRecordWriter"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(YosegiRecordWriter_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "jp.co.yahoo.yosegi.binary.optimizer.BinaryMakerOptimizerNode",
      ...
      "jp.co.yahoo.yosegi.spread.analyzer.Analyzer",
      "jp.co.yahoo.yosegi.binary.optimizer.BinaryMakerOptimizer",
      "jp.co.yahoo.yosegi.block.BlockReaderNameShortCut",
      ...
      "jp.co.yahoo.yosegi.writer.YosegiRecordWriter",
      ...
      "jp.co.yahoo.yosegi.writer.YosegiWriter",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(YosegiRecordWriter_ESTest_scaffolding.class.getClassLoader()); 
