...
public class FloatColumnAnalizer_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "jp.co.yahoo.yosegi.spread.analyzer.FloatColumnAnalizer"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(FloatColumnAnalizer_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("jp.co.yahoo.yosegi.spread.column.IArrowPrimitiveConnector", false, FloatColumnAnalizer_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("jp.co.yahoo.yosegi.spread.column.ICell", false, FloatColumnAnalizer_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(FloatColumnAnalizer_ESTest_scaffolding.class.getClassLoader()); 
