...
public class YosegiSpreadParser_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "jp.co.yahoo.yosegi.reader.YosegiSpreadParser"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(YosegiSpreadParser_ESTest_scaffolding.class.getClassLoader() ,
      "jp.co.yahoo.yosegi.spread.column.IColumnManager",
      "jp.co.yahoo.yosegi.message.objects.PrimitiveObject",
      "jp.co.yahoo.yosegi.message.parser.PrimitiveConverter",
      "jp.co.yahoo.yosegi.reader.YosegiSpreadParser",
      ...
      "jp.co.yahoo.yosegi.message.parser.ISettableIndexParser",
      "jp.co.yahoo.yosegi.reader.YosegiParserFactory$1",
      ...
      "jp.co.yahoo.yosegi.reader.YosegiNullParser",
      ...
      "jp.co.yahoo.yosegi.reader.YosegiParserFactory",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("jp.co.yahoo.yosegi.spread.column.IArrowPrimitiveConnector", false, YosegiSpreadParser_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("jp.co.yahoo.yosegi.spread.column.IColumnManager", false, YosegiSpreadParser_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(YosegiSpreadParser_ESTest_scaffolding.class.getClassLoader()); 
    ...
    org.evosuite.runtime.classhandling.ClassStateSupport.resetClasses(
      ...
      "jp.co.yahoo.yosegi.reader.YosegiArrayParser",
      "jp.co.yahoo.yosegi.message.parser.PrimitiveConverter",
      "jp.co.yahoo.yosegi.reader.YosegiParserFactory",
