...
public class Comment_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "jodd.lagarto.dom.Comment"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("jodd.lagarto.dom.NodeVisitor", false, Comment_ESTest_scaffolding.class.getClassLoader()));
  }
