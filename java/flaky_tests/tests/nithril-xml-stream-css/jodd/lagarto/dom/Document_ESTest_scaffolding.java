...
public class Document_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "jodd.lagarto.dom.Document"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("jodd.lagarto.dom.NodeVisitor", false, Document_ESTest_scaffolding.class.getClassLoader()));
  }
