...
public class Text_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "jodd.lagarto.dom.Text"; 
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("jodd.lagarto.dom.NodeVisitor", false, Text_ESTest_scaffolding.class.getClassLoader()));
  }
