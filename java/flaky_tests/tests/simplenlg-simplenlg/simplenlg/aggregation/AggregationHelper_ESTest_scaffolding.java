...
public class AggregationHelper_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "simplenlg.aggregation.AggregationHelper"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AggregationHelper_ESTest_scaffolding.class.getClassLoader() ,
      "simplenlg.features.NumberAgreement",
      "simplenlg.aggregation.AggregationHelper",
      "simplenlg.features.ClauseStatus",
      "simplenlg.framework.DocumentElement",
      "simplenlg.framework.ListElement",
      "simplenlg.aggregation.Periphery",
      ...
      "simplenlg.aggregation.FunctionalSet",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AggregationHelper_ESTest_scaffolding.class.getClassLoader()); 
