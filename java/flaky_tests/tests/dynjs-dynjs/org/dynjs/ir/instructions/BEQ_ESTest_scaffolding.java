...
public class BEQ_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "org.dynjs.ir.instructions.BEQ"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(BEQ_ESTest_scaffolding.class.getClassLoader() ,
      "org.dynjs.ir.Scope",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(BEQ_ESTest_scaffolding.class.getClassLoader()); 
