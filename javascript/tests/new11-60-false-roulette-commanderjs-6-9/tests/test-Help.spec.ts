export {}
const {Help} = require("../../../../syntest-javascript/benchmark/top10npm/commanderjs/lib/help.js");
const {Argument} = require("../../../../syntest-javascript/benchmark/top10npm/commanderjs/lib/argument.js");
const {Option} = require("../../../../syntest-javascript/benchmark/top10npm/commanderjs/lib/option.js");
const chai = require('chai');
const chaiAsPromised = require('chai-as-promised');
const expect = chai.expect;
chai.use(chaiAsPromised);
const {Command} = require("../../../../syntest-javascript/benchmark/top10npm/commanderjs/lib/command.js");
