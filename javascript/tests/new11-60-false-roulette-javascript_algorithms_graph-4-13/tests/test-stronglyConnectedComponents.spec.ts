// @ts-nocheck
export {}
import Comparator from "../../../syntest-javascript/benchmark/large_projects/javascript-algorithms/src/utils/comparator/Comparator.js";
import stronglyConnectedComponents from "../../../syntest-javascript/benchmark/large_projects/javascript-algorithms/src/algorithms/graph/strongly-connected-components/stronglyConnectedComponents.js";
const chai = require('chai');
const chaiAsPromised = require('chai-as-promised');
const expect = chai.expect;
chai.use(chaiAsPromised);
import Graph from "../../../syntest-javascript/benchmark/large_projects/javascript-algorithms/src/data-structures/graph/Graph.js";
